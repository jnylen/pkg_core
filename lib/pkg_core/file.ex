defmodule PkgCore.File do
  ...
  def remove_fs_metadata(data_dir) do
    ...
    |> Enum.each(fn path ->
      path
      |> PkgCore.File.remove_all_files_by_name(".DS_Store")
      |> PkgCore.File.remove_all_files_by_name("thumbs.db")
    end)
  end
  ...
  @doc """
  Remove tmp directories used when building
  """
